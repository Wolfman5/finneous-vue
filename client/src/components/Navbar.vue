<template>
      <div  id="navDiv" class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header id="myHeader" class="demo-header mdl-layout__header mdl-color--black mdl-color-text--white">
        <div class="mdl-layout__header-row inverted-color">
          ...
          <button class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon inverted-color" id="hdrbtn">
            <i class="material-icons inverted-color">more_vert</i>
          </button>
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--black mdl-color-text--white">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--black">
          ...
          <a class="mdl-navigation__link mdl-color-text--white" href=""><i class="material-icons" role="presentation">local_offer</i>Promos</a>
          <a class="mdl-navigation__link mdl-color-text--white" href=""><i class="material-icons" role="presentation">shopping_cart</i>Purchases</a>
          <a class="mdl-navigation__link mdl-color-text--white" href=""><i class="material-icons" role="presentation">people</i>Social</a>
          <div class="mdl-layout-spacer"></div>
